      ...
      <Dialog open={open} onOpenChange={updateOpen}>
        <DialogContent className='sm:max-w-[425px]'>
          <DialogHeader>
            ...
            <DialogDescription>
              Tell us which participant you are to let us customize how the information is
              displayed.
            </DialogDescription>
          </DialogHeader>
    ...
    <Drawer open={open} onOpenChange={updateOpen}>
      <DrawerContent>
        <DrawerHeader className='text-left'>
          ...
          <DrawerDescription>
            Tell us which participant you are to let us customize how the information is displayed.
          </DrawerDescription>
        </DrawerHeader>
        <ActiveUserForm className='px-4' group={group} close={() => setOpen(false)} />
