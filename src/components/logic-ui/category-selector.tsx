...
import { CategoryIcon } from '../app-ui/category-icons'
...
export function CategorySelector({ categories, onValueChange, defaultValue, isLoading }: Props) {
  ...
  return (
    <Command>
      ...
      <div className='w-full max-h-[300px] overflow-y-auto'>
        {Object.entries(categoriesByGroup).map(([group, groupCategories], index) => (
